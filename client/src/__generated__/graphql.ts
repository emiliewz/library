...
export type GetUserQuery = { __typename?: 'Query', me?: { __typename?: 'User', username: string, favoriteGenre: string, id: string } | null };

export type GetLoggedInUserQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLoggedInUserQuery = { __typename?: 'Query', getLoggedInUser?: { __typename?: 'Token', username: string, token: string, name: string } | null };
